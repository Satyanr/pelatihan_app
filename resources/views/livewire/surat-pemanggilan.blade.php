<div>
    <form action="">
        <div class="row my-3">
            ...
            <div class="col-lg-3">
                <input type="text" class="form-control" value="3470/D7.5/KP.04.00/20232">
            </div>
            <div class="col-lg-6 d-flex justify-content-end">
                <div class="col-lg-3">
                    <input type="text" class="form-control" value="4 Juli 2023">
                </div>
            </div>
        </div>
        <div class="row my-3">
            ...
            <div class="col-lg-3">
                <input type="text" class="form-control" value="Satu Set">
            </div>
        </div>
        <div class="row my-3">
            <div class="col-lg-1">
            ...
            <div class="col-6">
                <div id="hal">Pemanggilan Peserta Program Upskilling dan Reskilling
        ...
        <div class="row my-3">
            <div class="col">
                <div class="row my-2">
                    ...
                    <div class="col">
                        <input type="text" class="form-control" value="9 s.d. 22 Juli 2023">
                    </div>
                </div>
                <div class="row my-2">
                    ...
                    <div class="col-md-auto">:</div>
                    <div class="col">
                        <textarea class="form-control" aria-label="With textarea">BBMPV BMTI
Jalan Pasantren, Km. 2, Cibabat, Cimahi Utara 40513</textarea>
                ...
                <div class="row my-2">
                    ...
                    <div class="col">
                        <input type="text" class="form-control"
                            value="Sabtu, 22 Juli 2023 selambat-lambatnya pukul 12.00 WIB">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div id="summernote3">
                    ...
                    <p class="MsoListParagraph"
                        ...
                        <!--[if !supportLists]--><span
                            ...
                            style="font-size:12.0pt;mso-bidi-font-size: 11.0pt;line-height:115%">Usia maksimal 55 tahun;
                            <o:p></o:p>
                        </span>
                    </p>
        ...
        <div class="row mt-5 pt-4">
            ...
            <div class="col">
                <div class="row">
                    <div class="col-6">
                        <input type="text" class="form-control" value="Supriyono, M.Si.">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row my-3">
            ...
            <div class="col">
                <div class="row">
                    ...
                    <div class="col-6">
                        <input type="text" class="form-control" value="196308051985031005">
                    </div>
                </div>
            </div>
        </div>
