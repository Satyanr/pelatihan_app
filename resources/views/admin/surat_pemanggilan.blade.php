...
Jalan Pasantren, Km. 2, Cibabat, Cimahi Utara 40513</textarea>
                        ...
                        <div class="row my-2">
                            ...
                            <div class="col">
                                <input type="text" class="form-control"
                                    value="Minggu, 9 Juli 2023, mulai pukul 14.00 WIB" name='checkdanreg'>
                            </div>
                        </div>
                        <div class="row my-2">
                    ...
                    <div class="col">
                        <div class="d-grid gap-2 col-6 mx-auto">
                            ...
                            <a class="btn btn-secondary"
                                href="{{ route('suratpemanggilanmenu', $diklat->id) }}">Kembali</a>
                        </div>
                    </div>
                </div>
            </form>
            ...
            <form action="{{ route('suratpemanggilan.update', $surat->id) }}" method="post">
                ...
                <div class="row my-3">
                    <div class="col">
                        ...
                        <div class="row my-2">
                            ...
                            <div class="col">
                                <input type="text" class="form-control"
                                    value="{{ $surat->checkdanreg }}" name='checkdanreg'>
                            </div>
                        </div>
                        <div class="row my-2">
                            <div class="col-lg-2">pembukaan</div>
                            <div class="col-md-auto">:</div>
                            <div class="col">
                                <input type="text" class="form-control" value="{{ $surat->pembukaan }}"
                                    name='pembukaan'>
                            </div>
                        </div>
                        <div class="row my-2">
                            ...
                            <div class="col-md-auto">:</div>
                            <div class="col">
                                <input type="text" class="form-control" value="{{ $surat->penutupan }}"
                                    name='penutupan'>
                            </div>
                        </div>
                        <div class="row my-2">
                            ...
                            <div class="col">
                                <input type="text" class="form-control"
                                    value="{{ $surat->checkout }}" name='checkout'>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mt-5 pt-4">
                    ...
                    <div class="col">
                        <div class="row">
                            <div class="col-6">
                                <input type="text" class="form-control" value="{{ $surat->nama_kepala }}" name='nama_kepala'>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row my-3">
                    <div class="col">
                        <div class="row">
                            <div class="col-9">
                                <input type="text" class="form-control" value="{{ $surat->tembusan }}"
                                    name='tembusan'>
                            </div>
                        </div>
                    </div>
