        ...
        <form action="{{ route('diklat.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="progli" required>
                    </div>
                </div>
            </div>
            {{-- <div class="row">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <textarea class="form-control" id="summernote6" name="evaluasi" required></textarea>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <div class="text-center"><label class="form-label my-3 fw-bolder">Sertifikat</label></div>
                    <textarea class="form-control" id="summernote7" name="sertifikat" required></textarea>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <div class="text-center"><label class="form-label my-3 fw-bolder">Layanan Peserta</label></div>
                    <textarea class="form-control" id="summernote8" name="layanan_peserta" required></textarea>
                </div>
            </div>
            {{-- <div class="row">
                <div class="col">
                    <div class="text-center"><label class="form-label my-3 fw-bolder">Tata Tertib Pelaksanaan</label></div>
                    <textarea class="form-control" id="summernote9" name="ttertib_pelaksanaan" required></textarea>
                </div>
            </div> --}}
            <div class="row mt-3">
                <div class="col">
